...
class Game extends React.Component {
    ...
    createBox = () => {
        num += 1
        return <Box id={num} open={this.open} openAround={this.openAround} trackMines={this.trackMines} squareTaken={this.state.squareTaken} resetNum={this.resetNum} gameLog={this.state.gameLog} forceUpdateHandler={this.forceUpdateHandler}></Box>
    }
